...
public class GetSerhanKitapListQueryHandler :
    IRequestHandler<GetSerhanKitapListQuery, Result<PaginatedListDto<GetSerhanKitapDto>>>
{
    ...
    private static IQueryable<SerhanKitap> ApplyFiltering(IQueryable<SerhanKitap> query, GetSerhanKitapListQuery request)
    {
        // Null-safe filtering
