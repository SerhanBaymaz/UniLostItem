...
namespace Persistence.Migrations
{
    ...
    [Migration("20260505191100_AddLostItemAndClaimEntities")]
    partial class AddLostItemAndClaimEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ItemClaim", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.LostItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.ItemClaim", b =>
                {
                    b.HasOne("Domain.ApplicationUser", "Claimant")
                        .WithMany("Claims")
                        .HasForeignKey("ClaimantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.LostItem", "LostItem")
                        .WithMany("Claims")
